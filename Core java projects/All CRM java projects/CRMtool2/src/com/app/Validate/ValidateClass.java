...
public class ValidateClass {
	public static Customer customervalidateinput(String fname, String lname, String email, String pass, double amt,
			String dob, String plan, Map<String,Customer> cc) throws Eclass {
...
//		String ee = validate_email(newe, dab, cc);
		...
		return new Customer(fname, lname, ee, pass, amt, dab, tt);
	...
	public static String validate_email(String email,Map<String,Customer> customers) throws Eclass {
